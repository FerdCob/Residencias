...
class Post extends Model
{
    ...
    protected $fillable = ['title', 'slug', 'category_id', 'excerpt', 'body',  'user_id', 'published', 'image_path'];

    //Considerar usar is_published o recordar como se usa el post activo e inactivo
    protected $casts = [
